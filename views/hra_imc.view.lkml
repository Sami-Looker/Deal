view: hra_imc {
 derived_table: {
  indexes: ["cpf"]
  sql:SELECT *
,round((a.peso/((a.altura/100)^2)),1) as "imc"
,CASE
    WHEN (round((a.peso/((a.altura/100)^2)),1)) between 0 and 18.5 then 'Abaixo do Peso'
    WHEN (round((a.peso/((a.altura/100)^2)),1)) between 18.5 and 24.9 then 'Peso Normal'
    WHEN (round((a.peso/((a.altura/100)^2)),1)) between 25 and 29.9 then 'Sobrepeso'
    WHEN (round((a.peso/((a.altura/100)^2)),1)) between 30 and 34.9 then 'Obesidade'
    WHEN (round((a.peso/((a.altura/100)^2)),1)) between 35 and 100 then 'Obesidade Severa'
    end as "imc_cla"
FROM
