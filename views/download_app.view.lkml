...
(SELECT
    ...
    , e. created_at
    , ea.subject
      FROM m_hubspot.engagement_email ea
      LEFT JOIN m_hubspot.engagement_email_to et ON (ea.engagement_id = et.engagement_id)
      LEFT JOIN m_hubspot.engagement e ON (ea.engagement_id = e.id)
    ...
    , ee.CREATED
    , es.subject
      FROM m_hubspot.email_event_sent es
      LEFT JOIN m_hubspot.email_event ee ON (es.id = ee.id)
