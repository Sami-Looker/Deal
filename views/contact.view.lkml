view: contact {
  label: "Leads"
  sql_table_name:hubspotgro.contact ;;
  drill_fields: [id]
  ...
  dimension: parceirias {
    ...
    type: string
    sql: CASE
          WHEN ${campanha} = "AccountTech" or ${campanha} = "ACSP" or ${campanha} = "Allya" or ${campanha} = "Alper - Força de Vendas" or ${campanha} = "Bradoo Beauty" or ${campanha} = "Celebrar" or ${campanha} = "Market Up" or ${campanha} = "Indica Sami" or ${campanha} = "Indica Sami (Interno)" or ${campanha} = "Qipu"
